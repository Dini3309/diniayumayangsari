...
<body class="auth-body">
  ...
  <main class="auth-page">
    <section class="auth-card">
      ...
      <div class="auth-visual"><img src="{{asseet ('assets/images/png/dasher-ui-bootstrap-5.jpg') }}" alt="adminHMD dashboard interface"></div>
